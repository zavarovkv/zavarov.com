...
description = "Сравнивая top edTech компаний рунета, заметил забавную проблему экономики курсов с точки зрения масштабирования, с которой они живут. Не продуктовые edTech платформы вроде lingualeo, а компании, которые создают образовательные курсы для повышения грейда или переквалификации."
tags = ["edtech"]
categories = ["Статьи"]
+++
