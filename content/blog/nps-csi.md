...
description = "Многие коллеги по цеху (не обязательно продакты, но и маркетологи, исследователи) считают понятия пользовательской «лояльности» и «удовлетворенности» синонимичными; и измеряют удовлетворенность пользователей продуктом через оценку NPS. И это в корне неверно, давайте разберемся почему."
tags = ["метрики", "nps", "csi"]
categories = ["Статьи"]
+++
