...
Следует помнить, что «внимание — существенно ограниченный процесс. При возникновении дополнительных задач он исчерпывается, а если они еще и сложные, исчерпывается быстро» [9]. А тайм-менеджмент строится на двух простых принципах:
