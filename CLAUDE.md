...
- **Layouts**: `layouts/` contains all templates — self-contained, no theme dependency
  ...
  - `layouts/_default/baseof.html` — base HTML with Yandex.Metrika analytics, KaTeX math, Mermaid (deferred), scroll-to-top button
  ...
  - `layouts/partials/custom_body.html` — JS: Likely init, mobile menu, scroll-to-top (active nav highlighting is server-side)
  ...
  - `layouts/partials/footer.html` — footer with social icons (Telegram, Email, RSS)
